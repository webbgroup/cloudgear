...
def initialize_system():
    ...
    delete_file("/etc/apt/sources.list.d/liberty.list")
    execute("echo deb http://ubuntu-cloud.archive.canonical.com/ubuntu trusty-updates/liberty main >> /etc/apt/sources.list.d/liberty.list")
